...
namespace CPPBME280
{
    ...
    esp_err_t BME280SPI::InitSpi(CPPSPI::Spi *i_spi, const int ss)
    {
        ...
        return spi->RegisterDevice(0, ss, 7, 1);
    }
